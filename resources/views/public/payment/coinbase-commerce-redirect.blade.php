...
(function() {
    ...
    // Function to redirect to payment (using target="_top" to break out of iframe)
    function redirectToPayment() {
        ...
        if (isInIframe) {
            ...
            try {
                ...
                // If we can't access top (cross-origin), use form with target="_top"
    ...
    // Button click handler (immediate redirect)
