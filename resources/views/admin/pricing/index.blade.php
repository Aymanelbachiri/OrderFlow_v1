                                    ...
                                    @foreach($plans as $plan)
                                        <div class="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-lg transition-all duration-300 hover:border-[#D63613]/30">
                                            ...
                                            <div class="flex space-x-2">
                                                ...
                                                <a href="{{ route('checkout.show', ['plan_id' => $plan->id, 'source' => 'admin']) }}"
                                                   target="_blank"
                                                   class="flex-1 bg-blue-500 hover:bg-blue-600 text-white text-center py-2 px-3 rounded-lg text-sm font-semibold transition-all duration-300 flex items-center justify-center space-x-1">
