...
<div class="space-y-8">
    ...
    <div class="bg-[#F5F5F5] rounded-xl border border-[#D63613]/10 shadow-md p-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-[#201E1F] mb-2">Edit Admin</h1>
                <p class="text-[#201E1F]/60">Update admin information and permissions</p>
            </div>
    ...
    <!-- Main Form -->
    <div class="bg-[#F5F5F5] rounded-xl border border-[#D63613]/10 shadow-md p-6">
        <form action="{{ route('admin.super.admins.update', $admin) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-[#201E1F]/60 mb-2">New Password (leave blank to keep current)</label>
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-[#201E1F]/60 mb-2">Confirm New Password</label>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="can_manage_sources" value="1" {{ old('can_manage_sources', $permissions->can_manage_sources ?? false) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                            <span class="ml-2 text-sm text-[#201E1F]">Manage Sources</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="can_create_custom_products" value="1" {{ old('can_create_custom_products', $permissions->can_create_custom_products ?? false) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                            <span class="ml-2 text-sm text-[#201E1F]">Create Custom Products</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="can_send_renewal_emails" value="1" {{ old('can_send_renewal_emails', $permissions->can_send_renewal_emails ?? false) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                            <span class="ml-2 text-sm text-[#201E1F]">Send Renewal Emails</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="can_manage_pricing_plans" value="1" {{ old('can_manage_pricing_plans', $permissions->can_manage_pricing_plans ?? true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                            <span class="ml-2 text-sm text-[#201E1F]">Manage Pricing Plans</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="can_manage_reseller_credit_packs" value="1" {{ old('can_manage_reseller_credit_packs', $permissions->can_manage_reseller_credit_packs ?? false) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                            <span class="ml-2 text-sm text-[#201E1F]">Manage Reseller Credit Packs</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="can_manage_payment_config" value="1" {{ old('can_manage_payment_config', $permissions->can_manage_payment_config ?? true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                            <span class="ml-2 text-sm text-[#201E1F]">Manage Payment Config</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="can_view_orders" value="1" {{ old('can_view_orders', $permissions->can_view_orders ?? true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                            <span class="ml-2 text-sm text-[#201E1F]">View Orders</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="can_manage_orders" value="1" {{ old('can_manage_orders', $permissions->can_manage_orders ?? true) ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-[#D63613] focus:ring-[#D63613]">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" id="max_sources" name="max_sources" value="{{ old('max_sources', $permissions->max_sources ?? '') }}" min="0"
                                   class="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D63613] focus:border-transparent"
                        ...
                        <div>
                            ...
                            <input type="number" id="max_custom_products" name="max_custom_products" value="{{ old('max_custom_products', $permissions->max_custom_products ?? '') }}" min="0"
                                   class="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D63613] focus:border-transparent"
                                   placeholder="Unlimited">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="max_reseller_credit_packs" name="max_reseller_credit_packs" value="{{ old('max_reseller_credit_packs', $permissions->max_reseller_credit_packs ?? '') }}" min="0"
                                   class="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D63613] focus:border-transparent"
                                   placeholder="Unlimited">
                        </div>
                    </div>
