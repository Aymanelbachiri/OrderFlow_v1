...
@section('title', 'Create Reseller Credit Pack')
...
<div class="space-y-8">
    ...
    <div class="bg-[#F5F5F5] rounded-xl border border-[#D63613]/10 shadow-md p-6 animate-fade-in-up">
        <div class="lg:flex space-y-4 justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-[#201E1F] mb-2">Create Credit Pack</h1>
                <p class="text-[#201E1F]/60">Set up a new credit package for resellers</p>
            </div>
    ...
    <form action="{{ route('admin.reseller-credit-packs.store') }}" method="POST" class="space-y-5">
        @csrf
