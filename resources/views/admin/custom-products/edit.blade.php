            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="product_type" id="product_type" required
                        ...
                        <option value="hotplayer_activation" {{ old('product_type', $customProduct->product_type) === 'hotplayer_activation' ? 'selected' : '' }}>HotPlayer Activation</option>
                ...
                <div id="hotplayer_plan_container" style="display: none;">
                    ...
                    <select name="hotplayer_plan" id="hotplayer_plan"
                        ...
                        <option value="YEAR_1" {{ old('hotplayer_plan', $customProduct->metadata['hotplayer_plan'] ?? '') === 'YEAR_1' ? 'selected' : '' }}>1 Year</option>
                        <option value="FOREVER" {{ old('hotplayer_plan', $customProduct->metadata['hotplayer_plan'] ?? '') === 'FOREVER' ? 'selected' : '' }}>Lifetime</option>
                    </select>
                ...
                <div class="flex items-center">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="allow_direct_checkout" value="1" {{ old('allow_direct_checkout', $customProduct->allow_direct_checkout ?? false) ? 'checked' : '' }} class="sr-only peer">
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#D63613]/20 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#D63613]"></div>
