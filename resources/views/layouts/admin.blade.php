                    ...
                    <div class="space-y-2 ">
                        ...
                        <li>
                            <a href="{{ route('admin.clients.index') }}"
                                ...
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Clients</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.orders.index') }}"
                                ...
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Orders</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.reseller-credit-packs.index') }}"
                                ...
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Credit
                                    Packs</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.pricing.index') }}"
                                ...
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Pricing</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.custom-products.index') }}"
                                ...
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Custom Products</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.analytics.index') }}"
                                ...
                                title="Analytics">
                                <i class="fas fa-chart-line mr-3 group-hover:scale-110 transition-transform duration-200"></i>
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Analytics</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.sources.index') }}"
                                ...
                                title="Sources">
                                <i class="fas fa-link mr-3 group-hover:scale-110 transition-transform duration-200"></i>
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Sources</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.payment.config') }}"
                                ...
                                <i class="fa-solid fa-credit-card mr-3 group-hover:scale-110 transition-transform duration-200"></i>
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">Payment
                                    Config</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('admin.smtp.edit') }}"
                                class="nav-link flex items-center px-4 py-3 text-white hover:bg-[#DC4822]/10 hover:text-[#DC4822] rounded-lg transition-all duration-200 font-medium group {{ request()->routeIs('admin.smtp.*') ? 'bg-[#DC4822]/10 text-[#DC4822] border-r-4 border-[#DC4822]' : '' }}"
                                title="SMTP Settings">
                                <i class="fas fa-envelope mr-3 group-hover:scale-110 transition-transform duration-200"></i>
                                <span class="group-hover:translate-x-1 transition-transform duration-200 sidebar-text">SMTP Settings</span>
                            </a>
                        </li>
