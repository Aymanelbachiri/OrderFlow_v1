...
<head>
    ...
    <title>IPTV Panel Access - {{ $order->order_number }}</title>
</head>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="background-color: #10b981; padding: 40px 30px; text-align: center;">
                            ...
                            <p style="margin: 10px 0 0 0; color: #d1fae5; font-size: 16px;">Your IPTV Panel is Ready!</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 30px 0; font-size: 15px; color: #4a5568; line-height: 1.6;">Your credit pack order <strong>#{{ $order->order_number }}</strong> has been activated! Here are your IPTV panel access credentials.</p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 25px 0; background-color: #f0f9ff; border-left: 4px solid #3b82f6; border-radius: 6px;">
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <h3 style="margin: 0 0 20px 0; color: #1e40af; font-size: 20px; font-weight: bold;">Your Credit Pack Details</h3>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    ...
                                                    <span style="font-size: 14px; color: #075985; margin-left: 8px;">{{ number_format($creditPack->credits_amount) }} Credits</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="font-size: 14px; color: #1e40af; font-weight: 600;">Order Number:</span>
                                                    <span style="font-size: 14px; color: #075985; margin-left: 8px;">#{{ $order->order_number }}</span>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 25px 0; background-color: #f8fafc; border-radius: 6px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="margin: 0 0 15px 0; font-size: 18px; color: #334155; font-weight: bold;">Getting Started with Your IPTV Panel</p>
                                        <ul style="margin: 0; padding-left: 20px; color: #475569; font-size: 14px; line-height: 1.8;">
                                            <li>Log in to your IPTV panel using the credentials above</li>
                                            <li>Manage your services and customers from the dashboard</li>
                                            <li>Use your credits to create new subscriptions</li>
                                            <li>Monitor your usage and billing</li>
                                            <li>Access support and documentation</li>
                                        </ul>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 25px 0; background-color: #f8fafc; border-radius: 6px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0 0 10px 0; font-size: 14px; color: #475569;">Our support team is here to assist you:</p>
                                        <ul style="margin: 0; padding-left: 20px; color: #475569; font-size: 14px; line-height: 1.8;">
                                            @if(isset($contact_email) && $contact_email)
                                            <li>Email us at: <a href="mailto:{{ $contact_email }}" style="color: #10b981;">{{ $contact_email }}</a></li>
                                            @endif
                                            <li>Reference your order number: <strong>{{ $order->order_number }}</strong></li>
                                            <li>Access our knowledge base and tutorials</li>
                                            <li>Contact our technical support team 24/7</li>
                                        </ul>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="margin: 30px 0 0 0; padding-top: 20px; border-top: 1px solid #e2e8f0; font-size: 15px; color: #4a5568; line-height: 1.6;">Thank you for choosing {{ $company_name ?? config('app.name') }}!</p>
                            
                            <p style="margin: 20px 0 0 0; font-size: 14px; color: #718096; line-height: 1.6;">
                                Best regards,<br>
                                <strong style="color: #10b981;">The {{ $team_name ?? ($company_name ?? config('app.name')) . ' Team' }}</strong>
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #1e293b; padding: 30px; text-align: center;">
                            <p style="margin: 0 0 8px 0; font-size: 13px; color: #cbd5e1; font-weight: 600;">IPTV Panel Access - Order #{{ $order->order_number }}</p>
